...
|       Campo         |                       Valor                       |
|---------------------|---------------------------------------------------|
| Apellidos y nombres | Castro Espinoza Kevin Moises                      |
| Número de carnet    | 1250907019                                        |
| Correo institucional| kcastroe2@uteq.edu.ec                             |
| Fecha               | 2026-08-28                                        |
...
Desventaja: No revoca inmediatamente un access token ya emitido; si el token fue robado, sigue siendo válido hasta que expire. También la complejidad del sistema al manejar dos tipos de tokens y su ciclo de vida.
...
| Contrato      | WSDL         | OpenAPI opcional |
| Sobrecarga    | Alta         | Baja             |
| Tipado        | Estricto     | Más flexible     |
| Cliente móvil | Más complejo | Más sencillo     |
| Errores       | SOAP Fault   | Códigos HTTP     |
**
